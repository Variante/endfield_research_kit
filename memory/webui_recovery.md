...
- The same manifest now carries fail-closed `offlineRecovery` annotations from
  ...
  schema `sourceStoryGapQueue.v56`, its current-build evidence is active, all
  ...
  291 manifest keys plus ten overlay keys. The four e5m2 rows retain empty
  ...
  e5m1 adds five more zero-route manifest annotations, including the exact
  blank-owner NpcProxy consumer for `dlg_e5m1_3`. e6m1 adds three zero-route
  annotations: one audio-complete RadioTable definition and two registered
  dialogs. `dlg_e6m1_15` exposes both exact blank-owner NpcProxy consumers.
  ...
  e2m2 adds four zero-route annotations for `dlg_e2m2_7`,
  `misc_dlg_e2m2_1d5`, `misc_dlg_e2m2_4d5`, and `radio_e2m2_7`.
  `radio_e2m2_1`, `radio_e2m3_3`, and `radio_e6m3_1` instead remain connected
  without an offline badge through exact foreign MissionRuntime quest client
  actions in e2m1 q3, e2m2 q3, and e6m2 q25 respectively.
  e1m1 adds four zero-route annotations: registered roots
  `cutscene_e1m1_3_1_test` and `cutscene_e1m1_4`, TextTable-only
  `cutscene_e1m1_6`, and blank-owner NpcProxy dialog `dlg_e1m1_6`.
  The existing inline FMV shown for `cutscene_e1m1_6` remains a manual
  presentation override and is not rendered as mission-trigger evidence.
  e8m2 adds four zero-route radio annotations for `_1`, `_9`, `_15`, and
  `_16`; their audio-complete definitions remain visible without inventing a
  trigger from scene-entry fallback.
  e6m2 adds four zero-route annotations for `radio_e6m2_3`,
  `radio_e6m2_7`, `dlg_e6m2_1`, and `dlg_e6m2_2`. The two dialog cards expose
  their exact missionless NpcProxyEx consumers and authored option groups
  while retaining the explicit ownership, activation, and order gap.
