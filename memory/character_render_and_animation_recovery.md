...
- The observation-only Streamline schema-v2 capture retains a
  ...
  Native body pins and consistent CPU scopes do not prove an unpatched IFix
...
- The graphics-only Full screen-shadow observer is pinned to the August 25
  ...
  The memory interface uses a Vulkan-compatible ABI across backend implementations.
  Its D3D11 initializer installs local Map/Unmap shims and success-returning
