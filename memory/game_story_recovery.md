...
| Metric | Current |
| --- | ---: |
| Pipeline missions | 497 (490 MissionRuntime + 7 Story-only recovery shells) |
...
frontier (100 actionable core-isolated files remain across that bucket; the
next tied frontier includes `gm01m5` and `gm02m1`) and
