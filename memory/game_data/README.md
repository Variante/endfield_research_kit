...
| [`audio_naming_coverage.md`](audio_naming_coverage.md) -- what is named and owned, and what nothing reaches | 4 | 290 |
...
| File | Level | Lines |
| --- | --- | --- |
| [`serialization_memorypack.md`](serialization_memorypack.md) -- MemoryPack framing status, and the IL2CPP chain that resolves a formatter | 2 | 2251 |
