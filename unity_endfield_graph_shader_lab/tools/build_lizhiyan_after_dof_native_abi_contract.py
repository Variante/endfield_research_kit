                ...
                "nativeAdapter": {
                    ...
                    "survivorSortPublication": {
                        ...
                        "backendBoundary": {
                            ...
                            "descriptorMode": {
                                "recordProvenance": "finalizer copies metadata+0x28 to publication+0x10; 0x181048660 obtains that descriptor as item-0x58 and 0x1810487e1 passes it to 0x180619cf0, which reads dword descriptor+0x450",
                                ...
                                "constructorEvidence": "0x180ac63f0 constructs a matching 0x4e0 resource descriptor with +0x430/+0x450/+0x488 fields; its two direct construction callers 0x180a4bd4a and 0x180b3fab9 pass mode 0",
                                "builderEvidence": "0x180ba21b0 writes mode 0, propagated input mode, or mode 1; 0x180390a20 copies the +0x440..+0x460 field group including +0x450",
                                "aliasBoundary": "metadata+0x28 has not been statically aliased to the 0x180ac63f0 or 0x180ba21b0 products, so Li's selected mode remains unknown",
                            },
                            "graphicsFront": {
