                    ...
                    "survivorSortPublication": {
                        ...
                        "upstreamWorkerBoundary": {
                            ...
                            "jobConstruction": {
                                ...
                                "rootSubsystemTables": {
                                    ...
                                    "descriptorDWriter": "0x18109c9d0 repeats the M0 +0x28/+0x40/+0x44 hash lookup and at 0x18109ca2f writes its r9 native shading-state resource object to the selected 0x60-byte entry+0x28; the same object is immediately dereferenced through +0x10 and later resource-state fields",
                                    ...
                                    "descriptorDIdentity": "both direct insertion owners resolve the same native resource family initialized by 0x1805ff5e0 with vtable 0x181d87ef0; its embedded runtime type text is PPtr<HGSubsurfaceProfile>. The primary owner stores the returned M0 handle at owner+0x58, while the lazy owner creates the profile resource through 0x181222240 before insertion",
                        ...
                        "backendBoundary": {
                            ...
                            "descriptorMode": {
                                ...
                                "ownerPopulationBoundary": "0x18104ef90 transports existing M0/M1 pointers through the worker. M0 is populated earlier by 0x1810b9990 -> 0x18109c9d0, whose 0x18109ca2f store places the native HGSubsurfaceProfile resource at entry+0x28. The worker-local 0x1810442f0 map remains unrelated",
                                "aliasBoundary": "M0 entry+0x28 is now statically identified as a PPtr<HGSubsurfaceProfile> native resource, not an ordinary Unity Material; no static join yet proves which inserted profile handle/resource is used by Li Zhiyan or its +0x450 mode",
                            },
                            "graphicsFront": {
