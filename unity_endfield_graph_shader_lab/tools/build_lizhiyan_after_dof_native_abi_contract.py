                ...
                "nativeAdapter": {
                    ...
                    "survivorSortPublication": {
                        ...
                        "backendBoundary": {
                            ...
                            "behavior": "consumes the CPU publication/result object and reaches generic front-end virtual dispatch; opcode 0x2748 preserves its resource pointer into API-2 binding state and a later opcode 0x2730 can publish that state to a Vulkan descriptor, but no same-record identity is proven to reach a draw command",
                            ...
                            "commandInterpreter": {
                                ...
                                "sequenceBoundary": "same-instance records are conditionally consumed in append order, but no static producer edge guarantees 0x2748 -> 0x2730 -> 0x2731 or even that all three occur before the same recording end",
                                ...
                                "handoffExcludedWriters": "0x1810484e0..0x181049007 and its bounded direct callees contain no front +0x2a0 (0x2730) or +0x3e8 (0x2731) invocation",
                                "separateProducerCandidates": "generic helper 0x180623ef0 can invoke +0x2a0; getter-backed 0x1805a3790/0x1805a37f0 can invoke +0x3e8, but none shares a proven resource/result identity or recorder interval with the HGMesh handoff",
                            ...
                            "vulkanExecution": {
                                ...
                                "descriptorIdentityBoundary": "if a later generic 0x2730 occurs on the same API-2 context, it packages S+0x22d0/S+0x22a8/S+0x2a0 into the Vulkan descriptor-update worker; the HGMesh handoff itself emits no 0x2730 and does not prove this condition",
                                ...
                                "remainingIdentityEdge": "runtime proof that the same HGMesh publication resource participates in a later generic 0x2730 descriptor update and 0x2731 execution, then reaches a particular +0x2b50 callback node and specific draw record",
                            },
