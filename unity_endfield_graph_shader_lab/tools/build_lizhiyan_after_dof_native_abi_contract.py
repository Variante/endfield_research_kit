                    ...
                    "survivorSortPublication": {
                        ...
                        "upstreamWorkerBoundary": {
                            ...
                            "jobConstruction": {
                                ...
                                "identityBoundary": "this closes descriptor construction and scheduler registration, not who populates the M0/M1 tables, Li renderer membership, accepted-record identity, or final draw ownership",
                                "rootSubsystemTables": {
                                    ...
                                    "perMaterialCbBoundary": "HGShadingStateSystem.GetOrCreatePerMaterialCBHandle at 0x1801ee430 enters 0x1810c2ff0 and selects the same 0x60-byte M0 entry, but the inspected route reads entry resource state and does not prove the entry+0x28 descriptor-D writer",
                                    "remainingPopulationBoundary": "M0/M1 allocation, subsystem identity, table shape, manager injection, job transport, and finalizer consumption are closed; concrete entry population and especially M0 entry+0x28 descriptor D ownership remain unresolved",
                                },
                            },
                        },
                        ...
                        "backendBoundary": {
                            ...
                            "descriptorMode": {
                                ...
                                "ownerPopulationBoundary": "0x18104ef90 creates the 0xf0-byte worker descriptor and copies caller rdx/r8 to +0x00/+0x08 as M0/M1; 0x180ff8020 later passes them unchanged to 0x181039e90. Its 0x180ff82b5 -> 0x1810442f0 helper only populates a temporary 0x30-stride group-to-int32-index-vector map; it is not M0 and never writes M0 entry+0x28 descriptor D. The remaining producer is population of the caller-supplied M0/M1 tables before 0x18104ef90",
