                    ...
                    "survivorSortPublication": {
                        ...
                        "upstreamWorkerBoundary": {
                            ...
                            "jobConstruction": {
                                ...
                                "rootSubsystemTables": {
                                    ...
                                    "descriptorDWriter": "0x18109c9d0 repeats the M0 +0x28/+0x40/+0x44 hash lookup and at 0x18109ca2f writes its r9 native material/shading-state object to the selected 0x60-byte entry+0x28; the same object is immediately dereferenced through +0x10 and later material state fields",
                                    "materialInsertionCallers": "0x1811e1a24 and 0x18131b76b are the two direct calls to 0x1810b9990 found in the pinned UnityPlayer image; both pass an owner-held material ID in edx",
                                    ...
                                    "remainingPopulationBoundary": "M0 allocation, material insertion, entry+0x28 native-object ownership, manager injection, job transport, and finalizer consumption are closed; M1 concrete entry population and a Li-specific M0 handle/object selection remain unresolved",
                                },
                            },
                        },
                        ...
                        "backendBoundary": {
                            ...
                            "descriptorMode": {
                                ...
                                "ownerPopulationBoundary": "0x18104ef90 transports existing M0/M1 pointers through the worker. M0 is populated earlier by 0x1810b9990 -> 0x18109c9d0, whose 0x18109ca2f store places the native material/shading-state object at entry+0x28. The worker-local 0x1810442f0 map remains unrelated",
                                "aliasBoundary": "M0 entry+0x28 is now statically identified as the native material/shading-state object passed to 0x18109c9d0, but no static join yet proves which inserted handle/object is Li Zhiyan or its +0x450 mode",
                            },
                            "graphicsFront": {
