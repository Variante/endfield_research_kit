            ...
            "ecsRendererListProducer": {
                ...
                "nativeAdapter": {
                    ...
                    "behavior": "canonicalizes arguments, packs a 0x68-byte request, and registers a list handle; contains no entity iteration, survivor writes, sort loop, multi-draw dispatch, or final draw",
                        ...
                        "slotStatePointerOffset": "0x08",
                            ...
                            "contextOwnership": {
                                ...
                                "provenBoundary": "the accessor only reads singleton table slot 0x14; no writer/replacer for the cell and no destructor demonstrably operating on this context's +0xb0 manager has been found",
                            },
                        },
                    ...
                    "survivorSortPublication": {
                        ...
                        "notYetProven": ["semantic names of packed key fields", "indirect draw", "graphics backend submission", "slot-0x14 context writer/replacer/destructor owner"],
                    },
