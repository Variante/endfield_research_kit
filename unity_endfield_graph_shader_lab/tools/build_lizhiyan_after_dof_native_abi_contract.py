                ...
                "nativeAdapter": {
                    ...
                    "survivorSortPublication": {
                        ...
                        "backendBoundary": {
                            ...
                            "behavior": "consumes the CPU publication/result object, repeats its resource-table lookup, records 0x2748/0x274a, invokes resource-array builders, and reaches opcode 0x2730 through a pinned helper chain; no same-AfterDOF-interval 0x2731 or particular draw identity is proven",
                            ...
                            "commandInterpreter": {
                                ...
                                "sequenceBoundary": "the HGMesh front has a static path to 0x2730 on the same recorder family, but no static producer edge proves a later 0x2731 occurs in the same AfterDOF recording interval or belongs to this draw-list",
                                ...
                                "descriptorProducerRoute": "0x1810487e1 -> 0x180619cf0 -> 0x180623ef0; 0x180623f1d reacquires the graphics-front family through 0x180725dc0 and 0x1806243d3 invokes vtable +0x2a0, the 0x2730 writer",
                            ...
                            "vulkanExecution": {
                                ...
                                "descriptorIdentityBoundary": "the HGMesh front statically reaches the generic 0x2730 producer through 0x180619cf0 -> 0x180623ef0, and the handler packages S+0x22d0/S+0x22a8/S+0x2a0 into the Vulkan descriptor-update worker; the remaining boundary is the later 0x2731 interval/draw-list attribution",
                                ...
                                "remainingIdentityEdge": "proof that a later 0x2731 execution occurs in the same AfterDOF recorder interval and that the resulting +0x2b50 callback node is the particular HGMesh draw record rather than another shared-recorder command",
                            },
