...
DiagnosticVsOutput main(uint vertexId : SV_VertexID)
{
    DiagnosticVsOutput output;
    ...
    output.texcoord6 = float3(0.0, 0.0, 0.0);
    output.texcoord7 = float3(0.0, 0.0, 0.0);
    return output;
}
