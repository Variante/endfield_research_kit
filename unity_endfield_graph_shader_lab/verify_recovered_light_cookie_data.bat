...
set "METHOD=EndfieldGraphShaderLabEditor.EndfieldRecoveredLightCookieDataBatchVerifier.VerifyBatch"
set "OUTPUT_DIR=%PROJECT_PATH%\scratch\character_recovery\light_cookie_data"
set "MODE=%~1"
...
echo Validating recovered LightCookieData with %API%...
