...
set "METHOD=EndfieldGraphShaderLabEditor.EndfieldRecoveredReflectionFrameBatchVerifier.VerifyBatch"
set "OUTPUT_DIR=%PROJECT_PATH%\scratch\character_recovery\canonical_reflection_frame"
set "MODE=%~1"
...
echo Validating recovered canonical reflection frame with %API%...
