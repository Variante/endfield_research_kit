Shader "Hidden/Endfield/Diagnostics/OriginalDeferredResolverDxbc"
{
    SubShader
    {
        ...
        Pass
        {
            ...
            cbuffer EndfieldCB7 : register(b7) { float4 _EndfieldCB7[160]; };
            cbuffer EndfieldCB8 : register(b8) { float4 _EndfieldCB8[4]; };
            ...
            Texture2D<float4> _EndfieldTextureT11 : register(t11);
            Texture2D<float4> _EndfieldTextureT12 : register(t12);
            Texture3D<float4> _EndfieldTextureT13 : register(t13);
            Texture2D<float4> _EndfieldTextureT14 : register(t14);
            Texture2D<float4> _EndfieldTextureT15 : register(t15);
            Texture3D<float4> _EndfieldTextureT16 : register(t16);
            Texture3D<float4> _EndfieldTextureT17 : register(t17);
            ...
            // s0->t1, s1->t22, s2->3D probes, s3->t5, s4->t6 comparison.
            SamplerState sampler_EndfieldTextureT1 : register(s0);
            SamplerState sampler_EndfieldTextureT22 : register(s1);
            SamplerState sampler_EndfieldTextureT16 : register(s2);
            ...
            float4 BridgePixel(BridgeVaryings input) : SV_Target0
            {
                ...
                value += _EndfieldTextureT11.Load(int3(pixel, 0));
                value += _EndfieldTextureT12.Load(int3(pixel, 0));
                value += _EndfieldTextureT13.Load(int4(voxel, 0));
                value += _EndfieldTextureT14.Load(int3(pixel, 0));
                value += _EndfieldTextureT15.Load(int3(pixel, 0));
                value += _EndfieldTextureT16.Load(int4(voxel, 0));
                value += _EndfieldTextureT17.Load(int4(voxel, 0));
                ...
                value += _EndfieldTextureT22.SampleLevel(
                    sampler_EndfieldTextureT22, input.texcoord0, 0);
                value += _EndfieldTextureT16.SampleLevel(
                    sampler_EndfieldTextureT16, float3(input.texcoord0, 0), 0);
                ...
                value += _EndfieldCB6[215] + _EndfieldCB7[159] + _EndfieldCB8[3];
                return value;
            }
            ENDHLSL
        }
