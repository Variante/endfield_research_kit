    ...
    public static class EndfieldLiZhiyanM23ParticleRendererCaptureBuilder
    {
        ...
        private static string RenderManifest(string playerPath, string scenePath, bool diagnosticMaterial)
        {
            return "{\n" +
                ...
                "  \"source_operation_matrix_guidance\": \"Run each source-operation-* mode from the same build with the foreground flag, 30 setup frames, and DXCap -frame 7s; these paused diagnostics preserve short-lived source rows for operation comparison.\",\n" +
                "  \"source_operation_setparticles_command\": \"DXCap.exe -file <source-operation-setparticles.vsglog> -frame 7s -terminateonsave -c <player.exe> -endfield-m23-particle-renderer-capture -endfield-m23-particle-renderer-mode=source-operation-setparticles-identical -endfield-m23-particle-renderer-frames=30 " + ForegroundWindowArgument + " -endfield-m23-particle-renderer-output=<source-operation-setparticles.json>\",\n" +
                "  \"source_operation_custom1_command\": \"DXCap.exe -file <source-operation-custom1.vsglog> -frame 7s -terminateonsave -c <player.exe> -endfield-m23-particle-renderer-capture -endfield-m23-particle-renderer-mode=source-operation-custom1-identical -endfield-m23-particle-renderer-frames=30 " + ForegroundWindowArgument + " -endfield-m23-particle-renderer-output=<source-operation-custom1.json>\",\n" +
                "  \"source_operation_renderer_toggle_command\": \"DXCap.exe -file <source-operation-renderer-toggle.vsglog> -frame 7s -terminateonsave -c <player.exe> -endfield-m23-particle-renderer-capture -endfield-m23-particle-renderer-mode=source-operation-renderer-toggle -endfield-m23-particle-renderer-frames=30 " + ForegroundWindowArgument + " -endfield-m23-particle-renderer-output=<source-operation-renderer-toggle.json>\",\n" +
                "  \"source_operation_mesh_command\": \"DXCap.exe -file <source-operation-mesh.vsglog> -frame 7s -terminateonsave -c <player.exe> -endfield-m23-particle-renderer-capture -endfield-m23-particle-renderer-mode=source-operation-mesh-reassign -endfield-m23-particle-renderer-frames=30 " + ForegroundWindowArgument + " -endfield-m23-particle-renderer-output=<source-operation-mesh.json>\",\n" +
                "  \"source_operation_material_command\": \"DXCap.exe -file <source-operation-material.vsglog> -frame 7s -terminateonsave -c <player.exe> -endfield-m23-particle-renderer-capture -endfield-m23-particle-renderer-mode=source-operation-material-reassign -endfield-m23-particle-renderer-frames=30 " + ForegroundWindowArgument + " -endfield-m23-particle-renderer-output=<source-operation-material.json>\",\n" +
                "  \"source_operation_pause_play_command\": \"DXCap.exe -file <source-operation-pause-play.vsglog> -frame 7s -terminateonsave -c <player.exe> -endfield-m23-particle-renderer-capture -endfield-m23-particle-renderer-mode=source-operation-pause-play -endfield-m23-particle-renderer-frames=30 " + ForegroundWindowArgument + " -endfield-m23-particle-renderer-output=<source-operation-pause-play.json>\",\n" +
                "  \"source_operation_none_command\": \"DXCap.exe -file <source-operation-none.vsglog> -frame 7s -terminateonsave -c <player.exe> -endfield-m23-particle-renderer-capture -endfield-m23-particle-renderer-mode=source-operation-none -endfield-m23-particle-renderer-frames=30 " + ForegroundWindowArgument + " -endfield-m23-particle-renderer-output=<source-operation-none.json>\",\n" +
                "  \"source_combination_guidance\": \"The unpaused source rows are short-lived: use the foreground flag, 30 setup frames, and DXCap -frame 3.5s to capture both original particles; 4.4s retains one and 5.25s retains none on the validated machine.\",\n" +
                "  \"source_combination_material_gpu_command\": \"DXCap.exe -file <source-combination-material-gpu.vsglog> -frame 3.5s -terminateonsave -c <player.exe> -endfield-m23-particle-renderer-capture -endfield-m23-particle-renderer-mode=source-combination-material-gpu -endfield-m23-particle-renderer-frames=30 " + ForegroundWindowArgument + " -endfield-m23-particle-renderer-output=<source-combination-material-gpu.json>\",\n" +
                "  \"source_combination_material_streams_command\": \"DXCap.exe -file <source-combination-material-streams.vsglog> -frame 3.5s -terminateonsave -c <player.exe> -endfield-m23-particle-renderer-capture -endfield-m23-particle-renderer-mode=source-combination-material-streams -endfield-m23-particle-renderer-frames=30 " + ForegroundWindowArgument + " -endfield-m23-particle-renderer-output=<source-combination-material-streams.json>\",\n" +
                "  \"source_combination_gpu_streams_command\": \"DXCap.exe -file <source-combination-gpu-streams.vsglog> -frame 3.5s -terminateonsave -c <player.exe> -endfield-m23-particle-renderer-capture -endfield-m23-particle-renderer-mode=source-combination-gpu-streams -endfield-m23-particle-renderer-frames=30 " + ForegroundWindowArgument + " -endfield-m23-particle-renderer-output=<source-combination-gpu-streams.json>\",\n" +
                "  \"source_combination_all_command\": \"DXCap.exe -file <source-combination-all.vsglog> -frame 3.5s -terminateonsave -c <player.exe> -endfield-m23-particle-renderer-capture -endfield-m23-particle-renderer-mode=source-combination-all -endfield-m23-particle-renderer-frames=30 " + ForegroundWindowArgument + " -endfield-m23-particle-renderer-output=<source-combination-all.json>\",\n" +
                "  \"source_read_sync_guidance\": \"Run source-read particles/custom at 3.5s for live rows; the Pause control can be captured at 7s because it freezes them. All modes use the same renderer setup and then only the named read or Pause.\",\n" +
                "  \"source_read_particles_command\": \"DXCap.exe -file <source-read-particles.vsglog> -frame 3.5s -terminateonsave -c <player.exe> -endfield-m23-particle-renderer-capture -endfield-m23-particle-renderer-mode=source-read-particles -endfield-m23-particle-renderer-frames=30 " + ForegroundWindowArgument + " -endfield-m23-particle-renderer-output=<source-read-particles.json>\",\n" +
                "  \"source_read_custom1_command\": \"DXCap.exe -file <source-read-custom1.vsglog> -frame 3.5s -terminateonsave -c <player.exe> -endfield-m23-particle-renderer-capture -endfield-m23-particle-renderer-mode=source-read-custom1 -endfield-m23-particle-renderer-frames=30 " + ForegroundWindowArgument + " -endfield-m23-particle-renderer-output=<source-read-custom1.json>\",\n" +
                "  \"source_read_pause_command\": \"DXCap.exe -file <source-read-pause.vsglog> -frame 7s -terminateonsave -c <player.exe> -endfield-m23-particle-renderer-capture -endfield-m23-particle-renderer-mode=source-read-pause -endfield-m23-particle-renderer-frames=30 " + ForegroundWindowArgument + " -endfield-m23-particle-renderer-output=<source-read-pause.json>\",\n" +
