...
namespace EndfieldGraphShaderLabEditor
{
    public static class EndfieldEndminfEntranceVfxProbe
    {
        ...
        public static void RenderAndValidate()
        {
            ...
            bool recoveredPostSemantics = Enabled(
                RecoveredPostEnvironmentVariable);
            bool writeAllSamples = Enabled(WriteAllSamplesEnvironmentVariable);
            Shader.SetGlobalFloat(
                "_EndfieldRecoveredPostSemantics",
                recoveredPostSemantics ? 1f : 0f);
            ...
            foreach(string staleSample in Directory.GetFiles(output,"sample_*.png"))File.Delete(staleSample);
        ...
        private static bool Enabled(string name){string value=Environment.GetEnvironmentVariable(name);return string.Equals(value,"1",StringComparison.Ordinal)||string.Equals(value,"true",StringComparison.OrdinalIgnoreCase)||string.Equals(value,"on",StringComparison.OrdinalIgnoreCase);}
