...
set "METHOD=EndfieldGraphShaderLabEditor.EndfieldRecoveredVisibilitySHConstantsBatchVerifier.VerifyBatch"
set "OUTPUT_DIR=%PROJECT_PATH%\scratch\character_recovery\visibility_sh_constants"
set "MODE=%~1"
...
echo Validating recovered VisibilitySHConstData with %API%...
