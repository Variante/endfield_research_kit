...
set "METHOD=EndfieldGraphShaderLabEditor.EndfieldRecoveredLightBinningConstantsBatchVerifier.VerifyBatch"
set "OUTPUT_DIR=%PROJECT_PATH%\scratch\character_recovery\light_binning_constants"
set "MODE=%~1"
...
echo Validating recovered LightBinningConstants with %API%...
