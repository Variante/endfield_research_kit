...
| Streaming | `scripts/game_data/streaming.py`, `scripts/game_data/streaming_corpus.py` | `scripts/tests/test_streaming.py`, `scripts/tests/test_streaming_corpus.py` (all envelopes/roots, exact anonymous Info graphs, exact anonymous field-2 direct, field3/4/5 first-level, and field6/7 paired-group subgraphs; field-2 row fields/targets, deeper field-5 children, and semantics remain opaque) |
