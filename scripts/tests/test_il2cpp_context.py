...
class BuffUnionRouteTests(unittest.TestCase):
    def setUp(self):
        self.base=0x180000000
        self.instruction_targets={0x3910906,0x3910104,0x391096A,0x3910C8A,0x3910CBC,0x3910DB6,0x39109CE,0x3910618,0x390E7D2,0x3910168,0x390FDB2}
    ...
    def test_current_tag_routes_do_not_alias_old_names(self):
        row=self.decode();self.assertEqual([r['tag'] for r in row['rows'] if r['tag'] not in (188,334,346,402,224,13)],[201,192,64,118,236,80,287,180,86,146,87,91,60,120,178,104,129,88,2,154,162,101,361,343,110,254,150,253,124,182,128,366,123,109,310,355,105,68,271,155,197,281,10,122,136,72,90,196,325,222,189,106,36,363,126,53,234,97,63,333,115,93,66,39,149,116,365,352,137,369,306,212,96,294,28,6,322,3,81,94,315,132,133,372,65,169,98,316,144,187,11,12,43,277,337,319,320,152,374,147,373,252,131,314,134,99,107,119,392,391,313,394,309,290,92,387,47,348,367,5,58,76,336,167,414,8,288,159,27,135,82,142,293,292,335,113,112,345,22,376,193,257,199,411,296,356,207,299,44,295,171,246,380,390,185,244,307,330,349,55,298,324,347,7,395,412,138,331,358,370,40,258,398,206,23,173,408,407,145,388,223,31,183,240,85,54,32,168,35,362,111,353,284,140,78,148,344,364,377])
