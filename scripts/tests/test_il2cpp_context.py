...
class BuffUnionRouteTests(unittest.TestCase):
    def setUp(self):
        self.base=0x180000000
        self.instruction_targets={0x3910906,0x3910104,0x391096A,0x3910C8A,0x3910CBC,0x3910DB6,0x39109CE,0x3910618,0x390E7D2}
