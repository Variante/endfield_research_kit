...
# InteractiveData rows supply the Event identity. Runtime object ownership
# and branch execution remain unobserved.
NATIVE_CUSTOM_STATE_CALLSITE_CONTEXTS = {
    "au_int_rotateplatform_port_extense": {
        "consumerType": "Beyond.Gameplay.InteractiveLogicRotatePlatform",
        "consumerMethod": "_EnterStartCargoState",
        "methodIndex": 10135,
        "methodVa": "0x1871fe0f0",
        "callsiteVa": "0x1871fe1cd",
        "callsiteOffset": 221,
        "switchMethod": "Beyond.Gameplay.InteractiveLogicBase.SwitchAudioCustomState",
        "switchMethodVa": "0x187138eac",
        "staticArgumentVa": "0x18ef85850",
        "metadataUsageWord": "0xA000A919",
        "metadataStringLiteralIndex": "0x548C",
        "customStateName": "PortExtense",
        "triggerRole": "rotatePlatformStartCargoPortExtense",
        "branchCondition": "_EnterStartCargoState reaches the first SwitchAudioCustomState call",
    },
    "au_int_rotateplatform_rotate_normal_start": {
        "consumerType": "Beyond.Gameplay.InteractiveLogicRotatePlatform",
        "consumerMethod": "_EnterRotateState",
        "methodIndex": 10141,
        "methodVa": "0x1871fe02c",
        "callsiteVa": "0x1871fe0af",
        "callsiteOffset": 131,
        "switchMethod": "Beyond.Gameplay.InteractiveLogicBase.SwitchAudioCustomState",
        "switchMethodVa": "0x187138eac",
        "staticArgumentVa": "0x18ef85858",
        "metadataUsageWord": "0xA000B4FF",
        "metadataStringLiteralIndex": "0x5A7F",
        "customStateName": "RotateNormalStart",
        "triggerRole": "rotatePlatformEnterRotateNormalStart",
        "branchCondition": (
            "_EnterRotateState reaches the SwitchAudioCustomState call when "
            "this+0xbc != this+0xc0 or this+0xbc == this+0x94"
        ),
    },
    "au_int_rotateplatform_rotate_over_start": {
        ...
        "switchMethod": "Beyond.Gameplay.InteractiveLogicBase.SwitchAudioCustomState",
        "switchMethodVa": "0x187138eac",
        "staticArgumentVa": "0x18ef85860",
        "metadataUsageWord": "0xA000B503",
        "metadataStringLiteralIndex": "0x5A81",
        "customStateName": "RotateOverStart",
        "triggerRole": "rotatePlatformEnterRotateOverStart",
        "branchCondition": (
            "_EnterRotateState reaches the SwitchAudioCustomState call after "
            "this+0xbc == this+0xc0 and this+0xbc != this+0x94"
        ),
    },
    "au_int_rotateplatform_rotate_normal_loop": {
        "consumerType": "Beyond.Gameplay.InteractiveLogicRotatePlatform",
        "consumerMethod": "_TickRotateState",
        "methodIndex": 10152,
        "methodVa": "0x187200024",
        "callsiteVa": "0x18720008f",
        "callsiteOffset": 107,
        "switchMethod": "Beyond.Gameplay.InteractiveLogicBase.SwitchAudioCustomState",
        "switchMethodVa": "0x187138eac",
        "staticArgumentVa": "0x18ef85760",
        "metadataUsageWord": "0xA000B4FD",
        "metadataStringLiteralIndex": "0x5A7E",
        "customStateName": "RotateNormalLoop",
        "triggerRole": "rotatePlatformTickRotateNormalLoop",
        "branchCondition": (
            "_TickRotateState reaches the SwitchAudioCustomState call after "
            "the timer-comparison guards (neither jbe nor jb branch is taken)"
        ),
    },
    "au_int_rotateplatform_rotate_normal_end": {
        "consumerType": "Beyond.Gameplay.InteractiveLogicRotatePlatform",
        "consumerMethod": "_EnterStartCargoState",
        "methodIndex": 10135,
        "methodVa": "0x1871fe0f0",
        "callsiteVa": "0x1871fe1f3",
        "callsiteOffset": 259,
        "switchMethod": "Beyond.Gameplay.InteractiveLogicBase.SwitchAudioCustomState",
        "switchMethodVa": "0x187138eac",
        "staticArgumentVa": "0x18ef85830",
        "metadataUsageWord": "0xA000B4FB",
        "metadataStringLiteralIndex": "0x5A7D",
        "customStateName": "RotateNormalEnd",
        "triggerRole": "rotatePlatformStartCargoRotateNormalEnd",
        "branchCondition": "_EnterStartCargoState _CheckIsOn branch reaches the second SwitchAudioCustomState call",
    },
    "au_int_rotateplatform_port_retract": {
        "consumerType": "Beyond.Gameplay.InteractiveLogicRotatePlatform",
        ...
        "branchCondition": "_EnterStopCargoState reaches the SwitchAudioCustomState call",
    },
    "au_int_crane_rotating_start": {
        "consumerType": "Beyond.Gameplay.InteractiveLogicCrane",
        "consumerMethod": "_SwitchAudioStart",
        "methodIndex": 9066,
        "methodVa": "0x1871452e8",
        "callsiteVa": "0x18714537d",
        "callsiteOffset": 149,
        "switchMethod": "Beyond.Gameplay.InteractiveLogicBase.SwitchAudioCustomState",
        "switchMethodVa": "0x187138eac",
        "staticArgumentVa": "0x18f076008",
        "metadataUsageWord": "0xA001CF5B",
        "metadataStringLiteralIndex": "0xE7AD",
        "customStateName": "start_r",
        "triggerRole": "craneRotatingStart",
        "branchCondition": "_SwitchAudioStart direction argument equals 3",
    },
    "au_int_crane_vertical_start": {
        ...
        "methodIndex": 9066,
        "methodVa": "0x1871452e8",
        "callsiteVa": "0x1871453cf",
        "callsiteOffset": 231,
        "switchMethod": "Beyond.Gameplay.InteractiveLogicBase.SwitchAudioCustomState",
        "switchMethodVa": "0x187138eac",
        "staticArgumentVa": "0x18f0760d8",
        "metadataUsageWord": "0xA001CF65",
        "metadataStringLiteralIndex": "0xE7B2",
        "customStateName": "start_ver",
        "triggerRole": "craneVerticalStart",
        "branchCondition": "_SwitchAudioStart direction argument equals 2",
    },
    "au_int_crane_horizontal_start": {
        ...
        "methodIndex": 9066,
        "methodVa": "0x1871452e8",
        "callsiteVa": "0x18714541b",
        "callsiteOffset": 307,
        "switchMethod": "Beyond.Gameplay.InteractiveLogicBase.SwitchAudioCustomState",
        "switchMethodVa": "0x187138eac",
        "staticArgumentVa": "0x18f075ff8",
        "metadataUsageWord": "0xA001CF3F",
        "metadataStringLiteralIndex": "0xE79F",
        "customStateName": "start_hor",
        "triggerRole": "craneHorizontalStart",
        "branchCondition": "_SwitchAudioStart direction argument equals 1",
    },
    "au_int_crane_rotating_end": {
        "consumerType": "Beyond.Gameplay.InteractiveLogicCrane",
        "consumerMethod": "_SwitchAudioEnd",
        "methodIndex": 9067,
        "methodVa": "0x187145178",
        "callsiteVa": "0x18714520d",
        "callsiteOffset": 149,
        "switchMethod": "Beyond.Gameplay.InteractiveLogicBase.SwitchAudioCustomState",
        "switchMethodVa": "0x187138eac",
        "staticArgumentVa": "0x18f076050",
        "metadataUsageWord": "0xA00127A5",
        "metadataStringLiteralIndex": "0x93D2",
        "customStateName": "end_r",
        "triggerRole": "craneRotatingEnd",
        "branchCondition": "_SwitchAudioEnd direction argument equals 3",
    },
    "au_int_crane_vertical_end": {
        ...
        "methodIndex": 9067,
        "methodVa": "0x187145178",
        "callsiteVa": "0x18714525f",
        "callsiteOffset": 231,
        "switchMethod": "Beyond.Gameplay.InteractiveLogicBase.SwitchAudioCustomState",
        "switchMethodVa": "0x187138eac",
        "staticArgumentVa": "0x18f076078",
        "metadataUsageWord": "0xA00127A9",
        "metadataStringLiteralIndex": "0x93D4",
        "customStateName": "end_ver",
        "triggerRole": "craneVerticalEnd",
        "branchCondition": "_SwitchAudioEnd direction argument equals 2",
    },
    "au_int_crane_horizontal_end": {
        ...
        "methodIndex": 9067,
        "methodVa": "0x187145178",
        "callsiteVa": "0x1871452ab",
        "callsiteOffset": 307,
        "switchMethod": "Beyond.Gameplay.InteractiveLogicBase.SwitchAudioCustomState",
        "switchMethodVa": "0x187138eac",
        "staticArgumentVa": "0x18f076068",
        "metadataUsageWord": "0xA0012797",
        "metadataStringLiteralIndex": "0x93CB",
        "customStateName": "end_hor",
        "triggerRole": "craneHorizontalEnd",
        "branchCondition": "_SwitchAudioEnd direction argument equals 1",
    },
    "au_int_electric_fence_hit": {
        "consumerType": "Beyond.Gameplay.InteractiveLogicElectricFence",
        "consumerMethod": "_OnLeaderEnter",
        "methodIndex": 9340,
        "methodVa": "0x1871d1ae0",
        "callsiteVa": "0x1871d1d50",
        "callsiteOffset": 624,
        "switchMethod": "Beyond.Gameplay.InteractiveLogicBase.SwitchAudioCustomState",
        "switchMethodVa": "0x187138eac",
        "staticArgumentVa": "0x18f0a0128",
        "metadataUsageWord": "0xA0019993",
        "metadataStringLiteralIndex": "0xCCC9",
        "customStateName": "onHit",
        "triggerRole": "electricFenceLeaderEnterHit",
        "branchCondition": "_OnLeaderEnter reaches the SwitchAudioCustomState call after leader/tolerance gates",
    },
    "au_int_forge_iron_smoke": {
        "consumerType": "Beyond.Gameplay.InteractiveLogicForgeIron",
        "consumerMethod": "_CreateEffectOnTransform",
        "methodIndex": 9667,
        "methodVa": "0x1871e2aa8",
        "callsiteVa": "0x1871e2b9f",
        "callsiteOffset": 247,
        "switchMethod": "Beyond.Gameplay.InteractiveLogicBase.SwitchAudioCustomState",
        "switchMethodVa": "0x187138eac",
        "staticArgumentVa": "0x18ef80e08",
        "metadataUsageWord": "0xA00113F3",
        "metadataStringLiteralIndex": "0x89F9",
        "customStateName": "begin_produce_smoke",
        "triggerRole": "forgeIronSmokeStart",
        "branchCondition": "_CreateEffectOnTransform reaches the call when the smoke effect state is not already active",
    },
    "au_int_forge_iron_smoke_stop": {
        "consumerType": "Beyond.Gameplay.InteractiveLogicForgeIron",
        "consumerMethod": "_DestroyEffect",
        "methodIndex": 9669,
        "methodVa": "0x1871e2de0",
        "callsiteVa": "0x1871e2e86",
        "callsiteOffset": 166,
        "switchMethod": "Beyond.Gameplay.InteractiveLogicBase.SwitchAudioCustomState",
        "switchMethodVa": "0x187138eac",
        "staticArgumentVa": "0x18ef80cf8",
        "metadataUsageWord": "0xA001CFFD",
        "metadataStringLiteralIndex": "0xE7FE",
        "customStateName": "stop_produce_smoke",
        "triggerRole": "forgeIronSmokeStop",
        "branchCondition": "_DestroyEffect reaches the call after the active-effect guard",
    },
    "au_int_lifter_button_interact_failure": {
        "consumerType": "Beyond.Gameplay.InteractiveLogicLifterButton",
        "consumerMethod": "_OnClick",
        "methodIndex": 9836,
        "methodVa": "0x1871efbb0",
        "callsiteVa": "0x1871efdd9",
        "callsiteOffset": 553,
        "switchMethod": "Beyond.Gameplay.InteractiveLogicBase.SwitchAudioCustomState",
        "switchMethodVa": "0x187138eac",
        "staticArgumentVa": "0x18eff0f40",
        "metadataUsageWord": "0xA0012AA7",
        "metadataStringLiteralIndex": "0x9553",
        "customStateName": "failure",
        "triggerRole": "lifterButtonClickFailure",
        "branchCondition": "_OnClick failure branch reaches SwitchAudioCustomState",
    },
    "au_int_movingplat_start": {
        "consumerType": "Beyond.Gameplay.InteractiveLogicMovingPlatform",
        "consumerMethod": "_DoLocalMove",
        "methodIndex": 9984,
        "methodVa": "0x1871f7b20",
        "callsiteVa": "0x1871f7baa",
        "callsiteOffset": 138,
        "switchMethod": "Beyond.Gameplay.InteractiveLogicBase.SwitchAudioCustomState",
        "switchMethodVa": "0x187138eac",
        "staticArgumentVa": "0x18ef6c538",
        "metadataUsageWord": "0xA001CF45",
        "metadataStringLiteralIndex": "0xE7A2",
        "customStateName": "start_move",
        "triggerRole": "movingPlatformStartMove",
        "branchCondition": "_DoLocalMove reaches the call after the native patch/runtime gate",
    },
    "au_int_movingplat_end": {
        "consumerType": "Beyond.Gameplay.InteractiveLogicMovingPlatform",
        "consumerMethod": "_OnLocalMovingEnd",
        "methodIndex": 9987,
        "methodVa": "0x1871f7eec",
        "callsiteVa": "0x1871f7f69",
        "callsiteOffset": 125,
        "switchMethod": "Beyond.Gameplay.InteractiveLogicBase.SwitchAudioCustomState",
        "switchMethodVa": "0x187138eac",
        "staticArgumentVa": "0x18ef6c3d8",
        "metadataUsageWord": "0xA001CFF5",
        "metadataStringLiteralIndex": "0xE7FA",
        "customStateName": "stop",
        "triggerRole": "movingPlatformEndStop",
        "branchCondition": "_OnLocalMovingEnd timer comparison exceeds its threshold",
    },
}
...
MANAGED_AUDIO_CALLSITE_CONTEXTS = {
    **SELECTOR_AUDIO_CALLSITE_CONTEXTS,
    ...
    "au_gameplay_pause_spidle": {
        "consumerType": "Beyond.Gameplay.SnapshotSystem",
        "consumerMethod": "PauseAction", "methodIndex": 21953,
        "methodVa": "0x1873f7720", "literalLoadVa": "0x1873f789d",
        "literalArgumentRegister": "rdx", "literalArgumentInstruction": "ripRelativeManagedLiteralLoad",
        "playbackCall": "Beyond.Gameplay.Audio.AudioManager.PostEvent",
        "playbackCallVa": "0x1873f78a7", "playbackParameter": "entity,eventName",
        "targetBinding": "snapshotActionEntity", "triggerRole": "snapshotActionPause",
        "branchCondition": "PauseAction resolves the slot action state, marks it paused, then emits the pause Event",
    },
    "au_gameplay_resume_spidle": {
        "consumerType": "Beyond.Gameplay.SnapshotSystem",
        "consumerMethod": "_RemoveActionTimeScaleModifier", "methodIndex": 21960,
        "methodVa": "0x1873ffef4", "literalLoadVa": "0x1873fffd8",
        "literalArgumentRegister": "rdx", "literalArgumentInstruction": "ripRelativeManagedLiteralLoad",
        "playbackCall": "Beyond.Gameplay.Audio.AudioManager.PostEvent",
        "playbackCallVa": "0x1873fffe2", "playbackParameter": "entity,eventName",
        "targetBinding": "snapshotActionEntity", "triggerRole": "snapshotActionResumeAfterTimeScaleModifierRemoval",
        "branchCondition": "the slot state passes the time-scale cleanup path; the resume Event is emitted after the modifier is cleared",
    },
    ...
    if native_context.validated:
        for event_name, callsite in NATIVE_CUSTOM_STATE_CALLSITE_CONTEXTS.items():
            ...
            context = {
                ...
                "literal": callsite["customStateName"],
                "eventName": event_name,
                "eventHash": event_hash,
                "eventHashHex": f"0x{event_hash:08x}",
                "source": "GameAssembly.dll:.rdata metadata-usage string literal",
                "evidence": (
                    "exactCurrentBuildSwitchAudioCustomStateCallsiteAnd"
                    "AuthoredInteractiveCustomStateEvent"
                ),
                "playbackPlacementStatus": "exactManagedNativePlaybackCallsite",
                "runtimeConsumerStatus": "exactCurrentBuildNativeConsumer",
                "metadataSha256": native_context.metadata_sha256,
                "gameAssemblySha256": native_context.gameassembly_sha256,
                "runtimeExecutionStatus": "runtimeBranchExecutionUnobserved",
                **callsite,
            }
            context_utils.append_context(contexts, seen, event_name, context)
