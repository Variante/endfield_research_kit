...
def source_paths(repo_root: Path) -> dict[str, Path]:
    return {
        ...
        "rootNativeValidatorSha256": repo_root / "scripts/game_data/streaming_native.py",
        "rootNativeContractSha256": repo_root / "scripts/game_data/streaming_field2_native.json",
        ...
        "sharedMarker13ParserSha256": repo_root / "scripts/game_data/streaming_marker13.py",
        "sharedMarker13NativeValidatorSha256": repo_root / "scripts/game_data/streaming_marker13_native.py",
        "sharedMarker13NativeContractSha256": repo_root / "scripts/game_data/streaming_marker13_native.json",
        "marker2DirectorySha256": repo_root / "scripts/game_data/streaming_marker2_directory.py",
        "marker2ParserSha256": repo_root / "scripts/game_data/streaming_marker2.py",
        "marker2NativeValidatorSha256": repo_root / "scripts/game_data/streaming_marker2_native.py",
        "marker2NativeContractSha256": repo_root / "scripts/game_data/streaming_marker2_native.json",
        ...
        "sharedCorpusHelpersSha256": repo_root / "scripts/game_data/streaming_marker13_corpus.py",
