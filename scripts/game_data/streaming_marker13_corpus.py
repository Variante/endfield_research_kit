...
def source_paths(repo_root: Path) -> dict[str, Path]:
    return {
        ...
        "marker13GapParserSha256": repo_root / "scripts/game_data/streaming_marker13.py",
        "marker13NativeValidatorSha256": repo_root / "scripts/game_data/streaming_marker13_native.py",
        "marker13NativeContractSha256": repo_root / "scripts/game_data/streaming_marker13_native.json",
