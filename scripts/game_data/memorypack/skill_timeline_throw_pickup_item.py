...
LABEL = "skillTimelineThrowPickupItem"
CONTRACT_PATH = CONTRACTS_DIR / "skill_timeline_throw_pickup_item_native.json"
TAG = 0x017F
WRAPPER_NAME = "Beyond.MemoryPack.Beyond_Gameplay_Core_ThrowPickupItemAction_DataForMemoryPack"
TYPE_NAME = "Beyond.Gameplay.Core.ThrowPickupItemAction+Data"
...
def _contract() -> dict[str, Any]:
    contract, _digest = read_reviewed_contract(
        CONTRACT_PATH,
        schema="endfield.skill-timeline-throw-pickup-item-native-contract.v1",
        label=LABEL,
...
def decode_throw_pickup_item_action(reader: Reader, depth: int, tag: int, width: int) -> None:
    ...
    reader.take(1, "ThrowPickupItem.isEnable.byte")
    for field in FIELD_NAMES[1:]:
        reader.take(4, f"ThrowPickupItem.{field}.raw4")
