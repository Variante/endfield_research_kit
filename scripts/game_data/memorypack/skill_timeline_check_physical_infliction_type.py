"""Selected-build SkillData CheckPhysicalInflictionType 0x006D framing.
...
LABEL = "skillTimelineCheckPhysicalInflictionType"
CONTRACT_PATH = CONTRACTS_DIR / "skill_timeline_check_physical_infliction_type_native.json"
TAG = 0x006D
WRAPPER_NAME = "Beyond.MemoryPack.Beyond_Gameplay_Core_Conditions_CheckPhysicalInflictionType_DataForMemoryPack"
TYPE_NAME = "Beyond.Gameplay.Core.Conditions.CheckPhysicalInflictionType+Data"
FIELD_NAMES = (
...
SOURCE_READ_ORDER = (
    "byte", "scalar32", "scalar32", "scalar32", "scalar32", "byte-payload",
)
NESTED_TYPES = (
    "Beyond.Gameplay.Core.AbilityAction+AbilityActionData+Priority",
    "Beyond.Gameplay.Core.Conditions.CheckPhysicalInflictionType+CheckPhysicalInflictionEnum",
)
...
def _contract() -> dict[str, Any]:
    contract, _digest = read_reviewed_contract(
        CONTRACT_PATH,
        schema="endfield.skill-timeline-check-physical-infliction-type-native-contract.v1",
        label=LABEL,
    ...
    if (
        ...
        or contract.get("sourceContract") != "buff_6d_native.json"
...
def decode_check_physical_infliction_type_action(
