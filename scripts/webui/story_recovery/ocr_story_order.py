...
Commands::
    ...
    python -m scripts.webui.story_recovery.ocr_story_order sample [OCR options]
    python -m scripts.webui.story_recovery.ocr_story_order match [matching options]
    python -m scripts.webui.story_recovery.ocr_story_order publish [proposal options]
    python -m scripts.webui.story_recovery.ocr_story_order compare [comparison options]
