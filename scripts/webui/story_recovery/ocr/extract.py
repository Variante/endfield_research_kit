...
prefer:
    ...
    python -m scripts.webui.story_recovery.ocr_story_order match --run-ocr

Direct OCR-only runs are still useful for diagnostics:

    python -m scripts.webui.story_recovery.ocr_story_order sample
    python -m scripts.webui.story_recovery.ocr_story_order sample --frame-step 10
