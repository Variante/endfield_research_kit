...
# Edge-kind strength classification, mirroring scripts/webui/story/language_bundle.py.
...
EVIDENCE_POLICY = {
    "uses": [
        ...
        "source-backed LevelScriptData and AnimeStudio edges recovered by scripts/webui/story/build.py",
    ],
    "rejects": [
        "filename order",
...
def source_backed_story_call_contexts_from_scene_graph(
    ...
    for index, context in enumerate(contexts):
        ...
        row = {
            ...
            "sceneKeys": scene_keys,
            "recoveredBy": "scripts/webui/story/build.py",
        }
        if source:
...
def summarize(
    recovered: list[dict],
    timeline_meta: dict,
    generated_by: str = "scripts/webui/story/mission_recovery.py",
) -> dict:
    ...
    *,
    ...
    return {
        ...
        "summary": summarize(
            recovered,
            timeline_meta,
            generated_by="scripts/webui/story/build.py",
        ),
        "missions": recovered,
    }
