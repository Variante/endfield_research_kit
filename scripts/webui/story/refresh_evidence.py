...
STEPS = (
    EvidenceStep("dialog_registry", "scripts.webui.story.dialog_registry", ("--quiet",)),
    EvidenceStep("video_bindings", "scripts.webui.story.video_bindings"),
    EvidenceStep("source_links", "scripts.webui.story.source_links"),
    EvidenceStep(
        "spaceship_story_content",
        "scripts.webui.story.spaceship_story_content",
    ),
)
