...
if __package__ in {None, ""}:
    raise SystemExit(
        ...
        "python -m scripts.build_updates"
    )
...
from scripts.asset_builder.index import ASSET_KIND_BY_EXT, VIDEO_EXTENSIONS
...
from scripts.updates_builder.characters import build_character_updates
